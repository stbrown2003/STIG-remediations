<#
.SYNOPSIS
    This PowerShell script disables insecure logons to SMB Server.
...
# ==============================================================================
# STIG Fix: Windows 11 - Disable Insecure Guest Authentication (LanmanWorkstation)
# Hive:     HKEY_LOCAL_MACHINE
# Path:     SOFTWARE\Policies\Microsoft\Windows\LanmanWorkstation
# Value:    AllowInsecureGuestAuth = 0x00000000 (0) REG_DWORD
# ==============================================================================
