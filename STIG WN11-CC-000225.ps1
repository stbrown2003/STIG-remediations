...
# ==============================================================================
# STIG Fix: Windows 11 - Disable Pre-XP SP2 Shell Protocol Behavior
# Hive:     HKEY_LOCAL_MACHINE
# Path:     SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer
# Value:    PreXPSP2ShellProtocolBehavior = 0 (REG_DWORD)
# Note:     This STIG passes if the value is 0 OR if the value does not exist.
#           This script explicitly sets the value to 0 for an unambiguous result.
# ==============================================================================
